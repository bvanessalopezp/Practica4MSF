...
fg1 = plt.figure()
plt.plot(t,Pp0,'-',linewidth=1,color=[0.3372549019607843,0.5098039215686275,0.6941176470588235],label= 'Pp(t):Normotenso')
plt.plot(t,Pp1,'-',linewidth=1,color=[0.4509803921568627,0.6196078431372549,0.7882352941176471],label= 'Pp(t):Hipotenso')
plt.plot(t,Pp2,'-',linewidth=1,color=[0.255,0.232,0.219],label= 'Pp(t):Hipertenso')
plt.grid(False)
...
fg2 = plt.figure()
plt.plot(t,Pp0,'-',linewidth=1,color=[0.30,0.80,0.90],label= 'Pp(t):Normotenso')
plt.plot(t,Pp1,'-',linewidth=1,color=[0.115,0.158,0.201],label= 'Pp(t):Hipotenso')
...
fg3 = plt.figure()
plt.plot(t,Pp0,'-',linewidth=1,color=[0.10,0.51,0.160],label= 'Pp(t):Normotenso')
plt.plot(t,Pp1,'-',linewidth=1,color=[0.115,0.158,0.201],label= 'Pp(t):Hipotenso')
plt.plot(t,Pp4,':',linewidth=3,color=[0.255,0.232,0.219],label= 'Pp(t):Hipertenso PI')
plt.grid(False)
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel('Pp(t) [V]')
